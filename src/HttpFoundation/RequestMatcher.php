...
class RequestMatcher implements RequestMatcherInterface {
    ...
    /** @var array $params Extracted params from route regex */
     ...
     */
    public function matchIps( array|string|null $ips ): void {
    ...
    public function matches( RequestInterface $request ): bool {
        ...
        $requestUri = rawurldecode( trim($request->getPathInfo(), '/') );
        if ( null !== $this->path && ! preg_match( $this->path, $requestUri, $this->params) ) {
            return false;
        }
