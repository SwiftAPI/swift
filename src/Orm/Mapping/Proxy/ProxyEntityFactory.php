...
class ProxyEntityFactory extends \Cycle\ORM\Mapper\Proxy\ProxyEntityFactory {
    ...
    private readonly ClosureHydrator $hydrator;
    private readonly ClassPropertiesExtractor $propertiesExtractor;
    
    public function __construct() {
        $this->hydrator            = new ClosureHydrator();
        $this->propertiesExtractor = new ClassPropertiesExtractor();
        ...
        parent::__construct( $this->hydrator, $this->propertiesExtractor );
    }
    ...
    private function defineClass( RelationMap $relMap, string $class ): string {
        ...
        $className                = "{$class} Swift Orm Proxy";
        ...
        if ( ! class_exists( $className, false ) ) {
            ...
            $classStr = <<<PHP
                ...
                class {$classNameStr} extends \\{$class} implements \\Cycle\\ORM\\EntityProxyInterface {
                    ...
                    use \\Swift\Orm\\Mapping\\Proxy\\EntityProxyTrait;
                }
                PHP;
