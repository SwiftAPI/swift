...
final class HttpClientFactory implements ClientInterface {
    ...
    public function __construct(
        ...
        function middleware($middlewareHandler): \Closure {
            return function(callable $handler) use ($middlewareHandler) {
                return function (RequestInterface $request, array $options) use ($handler, $middlewareHandler) {
        ...
        $this->handlerStack->push(GuzzleRetryMiddleware::factory([
