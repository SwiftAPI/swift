...
namespace Swift\Authentication\Model;

use Exception;
use stdClass;
use Swift\Authentication\Helper\Token as HelperToken;
use Swift\Authentication\Model\Entity\Token;
use Swift\Model\Entity\EntityManagerList;
use Swift\Model\Entity\EntityManagerSingle;
use Swift\Authentication\Model\Entity\Client as entityClient;
