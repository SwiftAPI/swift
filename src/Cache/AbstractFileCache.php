...
abstract class AbstractFileCache extends FilesystemAdapter implements CacheItemPoolInterface {
    
    public function __construct(
        int $defaultLifetime = 0,
        MarshallerInterface $marshaller = null
    ) {
        parent::__construct('', $defaultLifetime, INCLUDE_DIR . '/var/cache/' . $this->getNameSpace() . '/', $marshaller);
    }
